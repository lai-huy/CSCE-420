...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.75\textwidth]{Question 4.png}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[height=256px]{Question 7 Simplified.png}
        \caption{Simplified Decision Tree}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[height=256px]{Question 7 Original.png}
...
\begin{figure}[!ht]
    ...
    \begin{tikzpicture}
        ...
        \draw  (1.25,17.25) rectangle  node {\LARGE $x_1$} (3.75,14.75);
        \draw  (1.25,13.5) rectangle node {\LARGE$x_2$} (3.75,11);
        \draw  (6.25,17.25) rectangle node {\LARGE$h_1$} (8.75,14.75);
        \draw  (6.25,13.5) rectangle node {\LARGE$h_2$} (8.75,11);
        \draw  (11.25,14.75) rectangle node {\LARGE$y$} (13.75,12.25);
        \draw [->, >=Stealth] (3.75,16) .. controls (5,16) and (5,16) .. (6.25,16);
        \draw [->, >=Stealth] (3.75,12.25) .. controls (5,12.25) and (5,12.25) .. (6.25,12.25);
        \draw [->, >=Stealth] (8.75,12.25) .. controls (10,13) and (10,13) .. (11.25,13.5);
        \draw [->, >=Stealth] (8.75,16) .. controls (10,14.75) and (10,14.75) .. (11.25,13.5);
        \draw [->, >=Stealth] (3.75,12.25) .. controls (5,14.25) and (5,14.25) .. (6.25,16);
        \draw [->, >=Stealth] (3.75,16) .. controls (5,14.25) and (5,14.25) .. (6.25,12.25);
    \end{tikzpicture}
...
\begin{figure}[!ht]
    \centering
    \includegraphics{Question 9 Decision Boundary.png}
